    ...
    <header x-data="{ isOpen: false }" class="w-full bg-gray-800 py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
              <a href="user_dashboard.php" class="flex items-center gap-2.5 opacity-75 hover:opacity-100 text-white py-2 pl-4 nav-item">
                ...
                <a href="change_p.php" class="flex items-center gap-2 text-white active-nav-link py-2 pl-4 nav-item">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"  fill="none">
                    ...
                    <div class="p-7">
                            ...
                            <span>Warning: Invalid password!</span>
										...
										?>
											...
											<form autocomplete="off" method="post" action="change_p.php" class="mt-6">				  
												<!-- current -->
                        <div class="mb-6">                          
                            <label
