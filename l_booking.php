...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="l_booking.php" class="flex items-center text-white active-nav-link gap-2.5 py-4 pl-6 nav-item">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
    ...
    <div class="w-full flex flex-col h-screen overflow-y-auto">
        ...
        <div class="lg:mx-10 mx-auto max-w-screen-2xl my-5 p-4 md:p-6 2xl:p-10">
              ...
              <div
                ...
                <nav>
                  <ol class="flex items-center gap-2">
                    ...
                    <li class="text-[#0E675C]">Booked Lawyers</li>
                  </ol>
                </nav>
              </div>
              <!-- Breadcrumb End -->                
            ...
            <div class="overflow-x-auto">
                <table class="table font-family-karla">
                    <!-- head -->
                    <thead>
                    <tr class="text-base">
                    <th></th>
                    ...
                    <?php
                                    ...
                                    user2.first_Name as lawyer_first_Name, 
                                    user2.last_Name as lawyer_last_Name, 
                                    booking.date, 
                                    booking.description, 
                                    booking.status as statuss 
                                FROM booking 
                                INNER JOIN client ON booking.client_id = client.client_id 
                                INNER JOIN user AS user1 ON client.client_id = user1.u_id 
                                INNER JOIN user AS user2 ON booking.lawyer_id = user2.u_id");
                                ...
                                <tbody id="myTable">
                                    <tr>
                                        ...
                                        <td><?php echo $row["lawyer_first_Name"]; ?> <?php echo $row["lawyer_last_Name"]; ?></td>
                                        <td><?php echo $row["date"]; ?></td>
                                        <td><?php echo $row["description"]; ?></td>
                                        <?php if ($row['statuss'] == 'Pending') { ?>
                                            <td>
                                            <button class="btn btn-sm btn-warning bg-yellow-400 flex items-center justify-center">
                                            <a class="flex items-center text-gray-700 py-2" href="l_booking.php?unblock_id=<?=$row['booking_id']?>">
