...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="a_lawyer.php" class="flex items-center text-white active-nav-link gap-2.5 py-4 pl-6 nav-item">
              ...
              <div
                ...
                <nav>
                  <ol class="flex items-center gap-2">
                    ...
                    <li class="text-[#0E675C]">Lawyers</li>
                  </ol>
                </nav>
              </div>
              <!-- Breadcrumb End -->                
                    ...
                    <tr>
                       <td>
                        ...
                        <button class="btn btn-sm btn-warning bg-yellow-400 flex items-center justify-center">
                            <a class="flex items-center text-gray-700 py-2" href="approve_lawyer.php?unblock_id=<?=$row['u_id']?>">
