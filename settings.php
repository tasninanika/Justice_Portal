...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="u_booking.php" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                <i class="fas fa-solid fa-question mr-3"></i>    
                Booking requests
            </a> 
            
            <details class="group">
                <summary class="flex items-center text-white active-nav-link py-4 pl-6 nav-item cursor-pointer">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-gray-800 py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
              <a href="user_dashboard.php" class="flex items-center gap-2.5 opacity-75 hover:opacity-100 text-white py-2 pl-4 nav-item">
                ...
                <a href="settings.php" class="flex items-center gap-2.5 text-white active-nav-link py-2 pl-4 nav-item">
                        ...
                        <div class="mb-6 flex flex-col gap-5 sm:flex-row">
                          ...
                          <div class="w-full sm:w-1/2">
                            <label
                              ...
                              for="zip"
                              >Zip Code</label>
                              <input type="text" name="zip_code" id="zip_code" value="<?php echo $row["zip_code"]; ?>" class="w-full rounded border border-stroke bg-gray px-5 py-3 font-medium text-black focus:border-gray-800 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary" placeholder="Enter zip code" />
                        </div>
                        <!-- button -->
                      </div>
