...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="a_user.php" class="flex items-center text-white active-nav-link gap-2.5 py-4 pl-6 nav-item">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
            ...
            <div class="overflow-x-auto">
                <table class="table font-family-karla">
                    ...
                    <tr>
                       <td>
                         <img
                         src="./images 2/upload/<?php echo $row["image"]; ?>"
                         alt="Avatar" class="mask mask-circle h-14 w-14" /> </td>
                        ...
                        <td>
                            <button class="btn btn-sm btn-block bg-red-600 flex items-center justify-center">
                            <a class="flex items-center text-white py-2" href="a_user.php?block_id=<?=$row['u_id']?>">
						...
						<td>
                            <button class="btn btn-sm btn-block bg-yellow-400 flex items-center justify-center">
                            <a class="flex items-center text-gray-700 py-2" href="a_user.php?unblock_id=<?=$row['u_id']?>">
