<header class = "bg-success">
	...
	<script>
		function MySucessFn(){
			swal({
				title: "Lawyer Registration Sucessfully Complete!",
				text: "",
				type: "success",
			...
			window.load = function(){
				window.location='http://localhost/lawyermanagementsystem/a_lawyer.php';
			});
		}
		function MyCheckFn(){
			swal({
				title: "Sorry!! This Email already exists..Please Fill up the form again",
				text: "",
				type: "warning",
			...
			window.load = function(){
				window.location='http://localhost/lawyermanagementsystem/add_lawyer.php';
			});
		}
	</script>
</header>
<?php
	...
	if($okFlag){
        ...
        else
        {
            ...
            $sql = "INSERT INTO `user` (`u_id`,`first_Name`, `last_Name`, `email`, `status`, `role`) 
			VALUES ('$u_id','$first_Name', '$last_Name', '$email ', 'Pending', 'Lawyer')";
          //echo $sql;exit;
