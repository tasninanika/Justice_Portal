...
<body class="bg-gray-100 font-family-karla flex">
    <aside class="relative h-screen w-96 hidden sm:block shadow-xl bg-gray-800">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="u_profile.php" class="flex items-center text-white active-nav-link gap-2.5 py-4 pl-6 nav-item">
                <svg
                    class="fill-current"
                    width="18"
                    height="18"
    ...
    <main>
          <div class="lg:mx-10 mx-auto max-w-screen-2xl my-5 p-4 md:p-6 2xl:p-10">
            <div class="mx-auto max-w-242.5">
              ...
              >
                <div class="relative z-20 h-72 md:h-65">
                  <img
                ...
                <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                  ...
                  >
                    ...
                    <img src="./images 2/upload/<?php echo $_SESSION["image"]; ?>" alt="User Image" class="lg:-mt-3 lg:-ml-3 rounded-full object-cover h-44 w-44 max-w-sm">
                    <label
                        for="profile"
                  ...
                  <div class="mt-4">
                    ...
                    <p class="font-medium">ID: <?php echo $row['client_id'];?></p>
                    <p class="font-medium">Email: <?php echo $_SESSION['email'];?></p>
                    <p class="font-medium">Contact: <?php echo $row['contact_number'];?></p>
